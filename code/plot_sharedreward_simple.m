function plot_sharedreward_simple(name,roidir, rois, models,mean_used)
...
% pictureslide = add(ppt, 'Title and Picture');
    ...
    for r = 1:length(rois)
        ...
        for m = 1:length(models)
            ...
            group_mean = load(strjoin([roidir,roi,model,mean_used], ''));
          
            
            figure, barweb_dvs2([mean(group_mean)],[std(group_mean)/sqrt(length(group_mean))])
